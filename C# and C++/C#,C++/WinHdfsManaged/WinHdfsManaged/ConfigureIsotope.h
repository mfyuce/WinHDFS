...
namespace Microsoft
{
    ...
    { 
        ...
        private:
            ...
            /// </returns>
			static array<System::String^>^ FindFiles(System::String^ path, System::String^ pattern);

			static array<System::String^>^ FindFiles(System::String^ path, System::String^ pattern, System::String^ description);
