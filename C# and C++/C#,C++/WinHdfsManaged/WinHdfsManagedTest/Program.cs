...
namespace Microsoft.WinHdfsManagedTest
{
    class Program
    {
        private const string BaseHdfsPath = "/user/hadoop/winlib";
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                using (HdfsFileSystem hdfsSystem = HdfsFileSystem.Connect("organon-dev-01", 9000,"hadoop"))
                {
        ...
        private static void FileTestStream(HdfsFileSystem hdfsSystem)
        {
            ...
            using (HdfsFileStream file = hdfsSystem.OpenFileStream(filename, HdfsFileAccess.Read))
            {
                ...
                Console.WriteLine();
                Console.WriteLine("Setting file times and owner to be 'hadoop'");
                file.Chown("hadoop", null);
